...
Provides a better update experience than raw `npx gsd-teams` by showing version diff and changelog entries.
</objective>
...
```bash
npm view gsd-teams version 2>/dev/null
```
...
To update manually: `npx gsd-teams --global`
```
